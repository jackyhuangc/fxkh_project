...
<template>
 ...
 <!-- <input type="button" value="xxxxxxxx" @click="initMap()" style="margin-left:300px;">  -->
    ...
    <klineinfo ref="kline" style="border:1px solid;height:200px;width:300px;left:0px;bottom:0px;position:absolute;">
    </klineinfo>
    <marketinfo ref="market" style="border:1px solid;height:200px;width:300px;left:0px;top:0px;position:absolute;">
    </marketinfo>
    <balanceinfo ref="balance" style="border:1px solid;height:200px;width:300px;right:0px;top:0px;position:absolute;">
    </balanceinfo>
    <tradinginfo ref="trading" style="border:1px solid;height:200px;width:300px;right:0px;bottom:0px;position:absolute;">
    </tradinginfo>
  </div>
</template>
