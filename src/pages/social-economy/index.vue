    ...
    <table class="tablelist">
      ...
      <tbody>
        <tr v-for="(item,index) in listGrid">
          ...
          <td>{{item.addvnm==''?item.addvcd:item.addvnm}}</td>
          <td>{{item.pubyear}}</td>
          <td>{{item.gdp}}</td>
          <td>{{item.indoutput}}</td>
          <td>{{item.eecaddoutput}}</td>
          <td>{{item.fiiaddoutput}}</td>
          <td>{{item.ttiaddoutput}}</td>
          <td>{{item.popunumb}}</td>
          <td>{{item.rpopnumb}}</td>
          <td>{{item.tohounum}}</td>
          <td>{{item.tlarea}}</td>
          <td>{{item.glarea}}</td>
          <td>
            <a href="#" class="tablelink" @click='yuan_click(index,item)'>详细</a>
          </td>
        </tr>
      </tbody>
    </table>
